...
const Splash = () => {
    ...
    const letterRef5 = useRef(null);

    const logoLetter = useRef(null);

    const logoAnimationRef = useRef(null);
    
    const bounceRef = useRef(null);
    const dotRef = useRef(null);
    const bouncedRef = useRef(null);
            ...
            <div className={styles.logoAnimationWrapper}>
                ...
                >
                    <div className={styles.animeLogo}>
                        <div className={styles.animeLogoSigns}>
                            <div 
                                className={`${styles.logoLetter} ${styles.letterA}`}
                                ref={letterRef1}
                            >
                                <svg 
                                    className={styles.bounced}
                                    ref={bouncedRef}
                                    viewBox="0 0 200 240" 
                                    width="200" 
                                    height="240"
                            ...
                            <div 
                                className={`${styles.logoLetter} ${styles.letterN}`}
                                ref={letterRef2}
                            >
                                <svg 
                                    className={styles.bounced}
                            ...
                            <div 
                                className={`${styles.logoLetter} ${styles.letterI}`}
                                ref={letterRef3}
                            >
                                <svg 
                                    className={styles.bounced}
                            ...
                            <div 
                                className={`${styles.logoLetter} ${styles.letterM}`}
                                ref={letterRef4}
                            >
                                <svg 
                                    className={styles.bounced} 
                            ...
                            <div 
                                className={`${styles.logoLetter} ${styles.letterE}`}
                                ref={letterRef5}
                            >
                                <svg 
                                    className={styles.bounced} 
